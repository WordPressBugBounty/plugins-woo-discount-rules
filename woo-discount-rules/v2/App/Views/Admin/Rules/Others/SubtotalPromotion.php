...
?>
    ...
    <div class="wdr_subtotal_promotion_container" style="display: grid;">
        ...
        <div class="wdr_cart_subtotal_promo_from">
            ...
            <span class="wdr_desc_text awdr-clear-both"><?php echo wp_kses_post(__("<b>Example:</b> Let's say you offer a 10% discount for 1000 and above. you may want to set 900 here. So that the customer can see the promo text when his cart subtotal reaches 900", 'woo-discount-rules')); ?></span>
        </div>
